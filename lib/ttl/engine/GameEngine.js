...
define(["require", "exports", '../core', '../system/AI', '../system/Spawn', '../system/Move'], function (require, exports, interfaces, AISystem, SpawnSystem, MoveSystem) {
    var GameEngine = (function (_super) {
        ...
        GameEngine.prototype.onStep = function () {
            globals.globalDeltaLogger.enqueue(globals.globalDeltaFactory.createStepDelta(this.stepNumber));
