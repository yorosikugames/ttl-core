...
(function (ttl) {
    var World = (function () {
        function World() {
            ...
            this.actorIntentQueue = new Array();
        ...
        World.prototype.enqueueBasic = function (str) {
            this.enqueue({
                toString: function () {
                    return str;
                },
        ...
        World.prototype.setDeltaLogger = function (dl) {
            this.dl = dl;
        ...
        World.prototype.appendMove = function (actor, action, beforeCell, afterCell) {
            ...
            if (typeof afterCell.beforeCells === 'undefined') {
                afterCell.beforeCells = new Array();
            }
