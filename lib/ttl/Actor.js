...
Actor.prototype.move = function(dix, diy) {
    var beforeCell = this.world.getCell(actor.getIx(), actor.getIy());
    var afterCell = this.world.getCell(actor.getIx() + dix, actor.getIy() + diy);
